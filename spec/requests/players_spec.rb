...
RSpec.describe "Players", type: :request do
  ...
  describe "GET /player/:name" do
    ...
    it "returns location, stats, avatar, equipment, and public player path in JSON" do
      ...
      expect(character_payload["stats"]).to include(
        "strength" => 1,
        "dexterity" => 1,
        "luck" => 1,
        "vitality" => 1,
      ...
      expect(character_payload["stats"]).not_to have_key("wisdom")
