...
- Domain: character
- Captured at: 2026-05-11 with later passes recorded below
- Source type: authenticated-live
- Evidence status: current within the captured profile/progression states
...
- Local status: Fully Implemented for the bounded Character Progression and
  Player Inventory handbooks
