...
- Domain: character (with Combat/Arena cross-domain evidence)
- Captured at: legacy December 2024 analysis with 2026 Wiki audit
- Source type: legacy-analysis and wiki
- Evidence status: mixed current/historical; verify each flow before extension
...
- Local status: Fully Implemented for bounded Character Progression and Arena
  Combat handbooks; uncaptured skills/effects remain unavailable
- Implementation handbooks: `doc/features/character_progression.md` and
...
Local implementation linkage is context, not direct Neverlands evidence. The
exhaustive inventories remain in handbook section 16.
