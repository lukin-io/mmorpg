...
- Domain: social
- Captured at: legacy December 2024 analysis
- Source type: legacy-analysis
- Evidence status: historical/current only where supported by fresh shell evidence
...
- Local status: Partially Implemented through the Game Shell handbook
...
exhaustive inventory remains in handbook section 16.
