...
- Domain: world (with NPC/Combat cross-domain evidence)
- Captured at: 2026-05-20 with 2026-07-21 follow-up
- Source type: authenticated-live
- Evidence status: current within the captured action/encounter boundary
...
- Local status: Fully Implemented for the declared World and Arena Combat
  boundaries; Quest behavior remains `NOT_IMPLEMENTED`
