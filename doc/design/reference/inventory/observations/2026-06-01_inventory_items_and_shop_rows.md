...
- Domain: inventory (with Economy cross-domain evidence)
- Captured at: 2026-06-01
- Source type: authenticated-live
- Evidence status: current within the bounded captured states
...
- Local status: Fully Implemented for the bounded Inventory handbook; adjacent
  transfer/targeted/crafting flows remain outside that boundary
- Implementation handbooks: `doc/features/player_inventory.md` and
