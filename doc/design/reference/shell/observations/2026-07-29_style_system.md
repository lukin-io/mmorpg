...
- Domain: shell/shared presentation
...
- Local status: implemented across bounded Shell, Character, Inventory, World,
  City, Shop, and Arena styles; individual feature status remains handbook-owned
- Implementation handbooks: `doc/features/game_shell.md`,
  `doc/features/character_progression.md`, `doc/features/player_inventory.md`,
