...
| Combat | One AP/body-part/block/log/result contract for arena PvP, arena NPC, wild NPC, and later dungeon fights, including physical and magic action variants. | Build the shared turn UI, combat profile, resolver, combat log, NPC response, PvP waiting, timeout, NPC loot check, and finish-result step. |
