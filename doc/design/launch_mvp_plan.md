...
| Injuries and healer | Persisted named injuries, expiry/stat penalties, movement/Inventory restrictions and same-cell treatment are implemented. Paid treatment needs patient acceptance; Hospital bags, Doctor license, Healer perk and Knowledge are checked. **[IMPL]** Authored Doctor proficiency thresholds are not enforced; [Medical Care](../features/medical_care.md#1-authority-and-scope) records the current audit. |
